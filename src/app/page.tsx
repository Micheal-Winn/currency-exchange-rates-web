  ...
  return (
    <main className="container lg:h-screen lg:overflow-hidden h-auto">
      ...
      <section className="w-full h-full flex flex-col-reverse lg:flex-row lg:pl-10">
        ...
        <h1 className="font-bold  text-2xl md:text-5xl lg:text-4xl 2xl:text-6xl xl:leading-tight mt-8 text-center lg:text-left">
            Unlock the World of <br />
            <span className="">Currency Exchange</span>
          </h1>
          <p className="font-semibold text-xs md:text-sm text-center  md:px-5 lg:px-0 lg:text-left tracking-wide leading-relaxed lg:tracking-wide text-slate-500 lg:leading-relaxed">
          ...
          <Btn text="Let&apos;s Start to exchange" funType="currency" className=" md:w-[12rem] mx-auto lg:mx-0 rounded-md xl:py-6 bg-[#1D1DFF] text-white font-semibold capitalize mt-2"/>
        </section>
